...
#include "TXDraw3DDelayCurves.h"
#include "TXFunctions.h"
#include "TXSystem.h"

TXDraw3DDelayCurves::TXDraw3DDelayCurves() {
    setup();
}

void TXDraw3DDelayCurves::setup(){
