 ...
 *
 *
 *  NOTE: TXSimpleLFO3 is not a TX Module. It's just to be used inside other modules,
 *        such as TXParticles3D.
 *
...
public:
    ...
    void getAllValues(TXLFO3DValues & dataArg);
    void setAllValues(TXLFO3DValues & dataArg);
    ...
    ofParameter<float> customCurveZMorph;
