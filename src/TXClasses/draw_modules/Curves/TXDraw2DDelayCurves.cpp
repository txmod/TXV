...
#include "TXDraw2DDelayCurves.h"
#include "TXFunctions.h"
#include "TXSystem.h"

TXDraw2DDelayCurves::TXDraw2DDelayCurves() {
    setup();
}

void TXDraw2DDelayCurves::setup(){
    ...
    // for all curves
     ...
     for (int curveIndex = 0; curveIndex < totalCurves; curveIndex++){
         ...
         for (int pointNo = 0; pointNo < totalPoints; pointNo++){
             ...
             arrdrawX[pointNo] = getMaxWidth() * arrCurvePoints[pointNo].getDelayDrawX(curveNo, totalCurves, holdDelayFrames, holdSpreadType, holdSpreadType2, holdSpreadTypeMorph);
             arrdrawY[pointNo] = getMaxHeight() * arrCurvePoints[pointNo].getDelayDrawY(curveNo, totalCurves, holdDelayFrames, holdSpreadType, holdSpreadType2, holdSpreadTypeMorph);
             
             if ((pointNo > 0) && (curveType->getInt() > TX2DCURVETYPE_STRAIGHT) ) {
                 arrcontrol1X[pointNo] = getMaxWidth() * arrCurvePoints[pointNo].getDelayControl1X(curveNo, totalCurves, holdDelayFrames, holdSpreadType, holdSpreadType2, holdSpreadTypeMorph);
                 arrcontrol1Y[pointNo] = getMaxHeight() * arrCurvePoints[pointNo].getDelayControl1Y(curveNo, totalCurves, holdDelayFrames, holdSpreadType, holdSpreadType2, holdSpreadTypeMorph);
                 
                 arrcontrol2X[pointNo] = getMaxWidth() * arrCurvePoints[pointNo].getDelayControl2X(curveNo, totalCurves, holdDelayFrames, holdSpreadType, holdSpreadType2, holdSpreadTypeMorph);
                 arrcontrol2Y[pointNo] = getMaxHeight() * arrCurvePoints[pointNo].getDelayControl2Y(curveNo, totalCurves, holdDelayFrames, holdSpreadType, holdSpreadType2, holdSpreadTypeMorph);
             };
         ...
         if (isAutoCurve) {
             if (isAutoClose || isFillShape) {
                 ...
                 if (usePoint1ForAutoCurveStart) {
                     ...
                     autoCurveStartX = getMaxWidth() * autoCurveStart.getDelayControl1X(curveNo, totalCurves, holdDelayFrames, holdSpreadType, holdSpreadType2, holdSpreadTypeMorph);
                     autoCurveStartY = getMaxHeight() * autoCurveStart.getDelayControl1Y(curveNo, totalCurves, holdDelayFrames, holdSpreadType, holdSpreadType2, holdSpreadTypeMorph);
                 };
                 if (useLastPointForAutoCurveEnd) {
                     ...
                     autoCurveEnd1X = getMaxWidth() * autoCurveEnd.getDelayControl1X(curveNo, totalCurves, holdDelayFrames, holdSpreadType, holdSpreadType2, holdSpreadTypeMorph);
                     autoCurveEnd1Y = getMaxHeight() * autoCurveEnd.getDelayControl1Y(curveNo, totalCurves, holdDelayFrames, holdSpreadType, holdSpreadType2, holdSpreadTypeMorph);
                     autoCurveEnd2X = autoCurveEnd1X;
                     autoCurveEnd2Y = autoCurveEnd1Y;
                 };
             };
