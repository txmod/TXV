 ...
 *  Copyright 2013 Paul Miller. All rights reserved.
 ...
 -------- NOTE: THIS IS THE OLD VERSION - HAS BEEN SUPERCEDED BY TXDrawDelayCurves ------------
...
class TXDraw2DDelayCurves  :  public TXDrawBase
{
public:
    
    // NOTE - see class TXDraw2DCurves re: total2DcurveTypes
