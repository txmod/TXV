...
//NSMutableDictionary * TXFractalBranch3D::getDictionary() {
...
//}
//
//void TXFractalBranch3D::setFromDictionary(NSMutableDictionary * dictionaryArg) {
//    NSNumber * holdNum;
//
//    //get data
