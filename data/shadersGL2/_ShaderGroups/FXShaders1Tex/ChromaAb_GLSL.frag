...
void main()
{
	...
	float rChannel		= texture2DRect( tex0, texcoord0 ).r;
	float gChannel		= texture2DRect( tex0, texcoord0 + offset ).g;
	float bChannel		= texture2DRect( tex0, texcoord0 + offset * 2.0 ).b;
