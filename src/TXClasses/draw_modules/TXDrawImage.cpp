...
void TXDrawImage::setup(){
	...
	drawShader.load("shadersES2/AlphaTextureTileShader.vert","shadersES2/AlphaTextureTileShader.frag");
    drawWithMaskShader.load("shadersES2/AlphaTexMaskShader.vert","shadersES2/AlphaTexMaskShader.frag");
    drawWithMaskTexShader.load("shadersES2/AlphaTexMaskShader.vert","shadersES2/AlphaTexMaskTexShader.frag");
#else
	if(ofIsGLProgrammableRenderer()){
		drawShader.load("shadersGL3/AlphaTextureTileShader.vert", "shadersGL3/AlphaTextureTileShader.frag");
        drawWithMaskShader.load("shadersGL3/AlphaTexMaskShader.vert","shadersGL3/AlphaTexMaskShader.frag");
        drawWithMaskTexShader.load("shadersGL3/AlphaTexMaskShader.vert","shadersGL3/AlphaTexMaskTexShader.frag");
    }else{
		drawShader.load("shadersGL2/AlphaTextureTileShader.vert", "shadersGL2/AlphaTextureTileShader.frag");
        drawWithMaskShader.load("shadersGL2/AlphaTexMaskShader.vert","shadersGL2/AlphaTexMaskShader.frag");
        drawWithMaskTexShader.load("shadersGL2/AlphaTexMaskShader.vert","shadersGL2/AlphaTexMaskTexShader.frag");
	}
#endif
...
void TXDrawImage::draw(){
    ...
    int holdMaskType;
    ofShader * holdShader;
//    bool setUniforms = true; // unused for now
 ...
 */
    ...
    //  choose shader
    if (holdMaskType == 0) {
        holdShader = & drawShader;
    } else if (holdMaskType == 1) {
        holdShader = & drawWithMaskTexShader;
    } else {
        holdShader = & drawWithMaskShader;
    };
...
void  TXDrawImage::imageAssetSlotChanged(string slotNameArg) {
...
void TXDrawImage::loadSourceImage() {
    ofPtr <TXAsset> asset;
    string fileName;
...
void TXDrawImage::loadMaskImage() {
    ofPtr <TXAsset> asset;
    string fileName;
...
int TXDrawImage::getTextureWidth() {
    if (sourceImage.getTexture().isAllocated()) {
...
int TXDrawImage::getTextureHeight() {
    if (sourceImage.getTexture().isAllocated()) {
...
ofTexture *  TXDrawImage::getTexture() {
    if (sourceImage.getTexture().isAllocated()) {
...
ofPixelsRef TXDrawImage::getPixels() {
