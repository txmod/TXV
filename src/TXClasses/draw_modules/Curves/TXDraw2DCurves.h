...
-------- NOTE: THIS IS THE OLD VERSION - HAS BEEN SUPERCEDED BY TXDrawCurves ------------
...
class TXDraw2DCurves  :  public TXDrawBase
{
public:
    
    // NOTE - adjust total2DcurveTypes when adding new types:
