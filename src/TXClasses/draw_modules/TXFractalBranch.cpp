...
//NSMutableDictionary * TXFractalBranch::getDictionary() {
...
//}
//
//void TXFractalBranch::setFromDictionary(NSMutableDictionary * dictionaryArg) {
//    NSNumber * holdNum;
//
//    //get data
